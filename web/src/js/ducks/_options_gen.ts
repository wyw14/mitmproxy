...
export interface OptionsState {
    ...
    addon_isolation: boolean;
    addon_isolation_max_failures: number;
    addon_isolation_timeout: number;
    allow_hosts: string[];
    anticache: boolean;
    anticomp: boolean;
...
export const defaultState: OptionsState = {
    ...
    addon_isolation: false,
    addon_isolation_max_failures: 3,
    addon_isolation_timeout: 10.0,
    allow_hosts: [],
    anticache: false,
    anticomp: false,
    block_global: true,
